      ...
      <header>
        ...
        <div><br>
            ...
            <body>
                ...
                <div class="container">
                    <div class="box">
                       <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="american hot.jpg"></A>
                        <h2>American Hot</h2>
                    </div>
                    <div class="box">
                        <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="cappriciosa.jpg"></A>
                        <h2>    Cappriciosa</h2>
                    </div>
                    <div class="box">
                        <A href=""<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="garden.jpg"></A>
                        <h2>Garden</h2>
                    </div>
                    <div class="box">
                        <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="margarita pizza.jpg"></A>
                ...
                <div class="container">
                    <div class="box">
                       <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="bbq beef.jpg"></A>
                        <h2>BBQ Beef</h2>
                    </div>
                    <div class="box">
                        <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="bbq chicken.jpg"></A>
                        <h2>BBQ Chicken</h2>
                    </div>
                    <div class="box">
                        <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="deluxe.jpg"></A>
                        <h2>Deluxe</h2>
                    </div>
                    <div class="box">
                        <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="extravaganzza.jpg"></A>
                        <h2>Extravaganzza</h2>
                    </div>
                ...
                <div class="container">
                    <div class="box">
                       <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>"  ><img src="greek.jpg"></A>
                        <h2>Greek</h2>
                    </div>
                    <div class="box">
                        <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="italian passion.jpg"></A>
                        <h2>Italian Passion</h2>
                    </div>
                    <div class="box">
                        <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="pepperoni pasion.jpg"></A>
                        <h2>Pepperoni Pasion</h2>
                    </div>
                    <div class="box">
                        <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="dominos special.jpg"></A>
                        <h2>Dominos Special</h2>
                    </div>

...
<html>
    ...
    <body>
      <style>
      .divi{
        background-color: rgba(224, 218, 211, 0.863);
      }
    ...
    <nav class="navbar navbar-expand-lg navbar-dark header-backgraund">
        ...
        <div class="container divi">
          <div>
            <h2>Pizza</h2>
            <p>Pizza është një ushqim shumë i popullarizuar dhe Domino është një nga picerit kryesorë në Kosovë që ofron shërbime të jashtëzakonshëm të shpërndarjes.

              Çdo ditë, më shumë se 1 milion klientë shijojnë produktet e nxehta dhe të shijshme të Domino në çdo kontinent të banuar në Tokë.
               Rreth e qark botës, Domino është e përkushtuar për një fokus të vetëm me mendje për ofrimin e pizzave të shijshme të shpërndara direkt në derën tuaj.
                Ne ishim pionier në biznesin e shpërndarjes së pizzave dhe sistemi ynë shet çdo vit më shumë se 500 milionë pizza në mbarë botën. 
                Domino aktualisht ka mbi 5.000 dyqane jashtë Shteteve të Bashkuara dhe në mbi 85 tregje ndërkombëtare, dhe ne jemi ende në rritje</p>
              </div>
              <button type="button" class="btn btn-danger "><a href="meny.php">Porosit  tani</a></button>
              <div>
                <h4>Nese ju intereson akoma me shum rreth nesh ateher kliko butonin !</h4>
                <button type="button" class="btn btn-danger "><a href="rrethnesh.xml">Ketu</a></button>

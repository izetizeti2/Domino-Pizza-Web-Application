  ...
  <nav class="navbar navbar-expand-lg navbar-dark header-backgraund">
      <div class="container-fluid header">
        ...
        <div><br>
            ...
            <div class="col-md-10 shiriti" id="div1">
              <p>BUKE</p>
            </div>
          </div>
            <div class="container">
              ...
              <div class="box">
                 <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="mozarellasticks.jpeg"></A>
                  <h2>Mozzarella Sticks</h2>
              </div>
              <div class="box">
                  <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>"  ><img src="twistybread.jpeg"></A>
                  <h2>Twisty Bread</h2>
              </div>
              <div class="box">
                  <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="patato wedges.jpg"></A>
                  <h2>Potato Wedges</h2>
              </div>
              <div class="box">
                  <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="mini twisty bread.jpg"></A>
                  <h2>Miini Twisty Bread</h2>
              </div>
              
          </div>
          <div class="container">
            <div class="box">
               <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>"  ><img src="garlic bread.jpg"></A>
                <h2>Garlic Bread</h2>
            </div>
            <div class="box">
                <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="parm bites.jpg"></A>
                <h2>Parm Bites</h2>
            </div>
        ...
        <div class="container">
          <div class="box">
            <A href="<?php echo isset($_SESSION['user']) ? 'checkuot1.php' : 'kyqu.php'; ?>"  ><img src="salc barbecue.jpg"></A>
            <h2>Salce Barbecue</h2>
        </div>
          <div class="box">
              <A href="<?php echo isset($_SESSION['user']) ? 'checkuot1.php' : 'kyqu.php'; ?>" ><img src="salc hudhre.jpg"></A>
              <h2>Salce Hudhre</h2>
          </div>
          <div class="box">
              <A href="<?php echo isset($_SESSION['user']) ? 'checkuot1.php' : 'kyqu.php'; ?>" ><img src="salc ranch.jpg"></A>
              <h2>Salce Ranch</h2>
          </div>
          <div class="box">
              <A href="<?php echo isset($_SESSION['user']) ? 'checkuot1.php' : 'kyqu.php'; ?>" ><img src="salc e embel djegzt.jpg"></A>
              <h2>Salce e Embel e Djegest</h2>
          </div>
      ...
      <div class="container">
        <div class="box">
           <A href="<?php echo isset($_SESSION['user']) ? 'checkuot1.php' : 'kyqu.php'; ?>" ><img src="salc djegs.jpg"></A>
            <h2>Salce e Djegest</h2>
        </div>
        <div class="box">
            <A href="<?php echo isset($_SESSION['user']) ? 'checkuot1.php' : 'kyqu.php'; ?>"  ><img src="keqap heinz.jpg"></A>
            <h2>Keqap Heniz</h2>
        </div>
        <div class="box">
            <A href="<?php echo isset($_SESSION['user']) ? 'checkuot1.php' : 'kyqu.php'; ?>" ><img src="majanez heinz.jpg"></A>
            <h2>Majonez Heinz</h2>
        </div>

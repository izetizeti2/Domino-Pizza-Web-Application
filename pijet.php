     ...
     <header>
      <nav class="navbar navbar-expand-lg navbar-dark header-backgraund">
        ...
        <div><br>
            ...
            <div class="container">
                <div class="box">
                <a href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>"><img src="cocacola.jpeg"></a>
                    <h2>CocaCola</h2>
                </div>
                <div class="box">
                    <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="cocacolaz.jpeg"></A>
                    <h2>CocaCola Zero</h2>
                </div>
                <div class="box">
                    <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="fanta.jpeg"></A>
                    <h2>Fanta</h2>
                </div>
                <div class="box">
                    <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>"  ><img src="sprite.jpeg"></A>
                    <h2>Sprite</h2>
            ...
            <div class="container">
                <div class="box">
                   <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="rugove.jpeg"></A>
                    <h2>Uje Rugove</h2>
                </div>

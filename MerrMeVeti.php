    ...
    <body>
      <header>
        <nav class="navbar navbar-expand-lg navbar-dark header-backgraund">
            ...
            <div class="container">
                <div class="box">
                   <A href="MerrMeVeti.php" ><img src="motorri1.jpeg"></A>
                    <h2 style="text-align: center;">MERR ME VETI</h2>
                </div>
                <div class="box">
                    <A href="dergesa.php" ><img src="njeri1.jpeg"></A>
                    <h2 style="text-align: center;">DERGESA</h2>
                </div>
            </div>
            <div class="container">
             
                  <A href="https://www.google.com/maps/search/Domino's+Pizza/@42.6048661,20.8462895,10z/data=!3m1!4b1" ><img src="lokacioni.png" width="600px" ></A>
                  
        
            </div>
            <h2 style="text-align: center;">Lokacioni</h2>

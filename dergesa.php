    ...
    <body>
      <header>
        <nav class="navbar navbar-expand-lg navbar-dark header-backgraund">
            ...
            <div class="container">
                <div class="box">
                   <A href="MerrMeVeti.html" ><img src="motorri1.jpeg"></A>
                    <h2 style="text-align: center;">MERR ME VETI</h2>
                </div>
                <div class="box">
                    <A href="dergesa.html" ><img src="njeri1.jpeg"></A>
                    <h2 style="text-align: center;">DERGESA</h2>
                </div>
            </div>

            <form style="padding-left: 30%; padding-right: 25%;">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputName" placeholder="Emri">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="inputSurname">Mbiemri</label>
                    <input type="text" class="form-control" id="inputSurame" placeholder="Mbiemri">
                  </div>
                </div>
                <div class="form-group col-md-6">
                  <label for="inputAddress">Emri i Rruges</label>
                  <input type="text" class="form-control" id="inputAddress" >
                </div>
                <div class="form-group col-md-6">
                  <label for="inputAddress2">Emri i lagjes</label>
               ...
               <br>
                <button type="submit" class="btn btn-primary" onclick="alert('Keni kryer porosine me sukses!')">Vazhdo</button>
              </form>
            </div>
        </body><br>

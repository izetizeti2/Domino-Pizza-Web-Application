        ...
        <div><br>
            ...
            <div class="container">
              ...
              <div class="container">
                ...
                <div class="box">
                   <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>"  ><img src="choco pie.jpg"></A>
                    <h2>Choco Pie</h2>
                </div>
                <div class="box">
                    <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="choco pie with oreo.jpg"></A>
                    <h2>Choco Pie With Oreo</h2>
                </div>
                <div class="box">
                    <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>"  ><img src="choco pizza.jpg"></A>
                    <h2>Choco Pizza</h2>
                </div>
                <div class="box">
                    <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="choco pizza with oreo.jpg"></A>
                    <h2>Choco Pizza With Oreo</h2>
                </div>
                
            </div>
            <div class="container">
              <div class="box">
                 <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>" ><img src="lava cake.jpg"></A>
                  <h2>Lava Cake</h2>
              </div>
              <div class="box">
                  <A href="<?php echo isset($_SESSION['user']) ? 'checkuot4.php' : 'kyqu.php'; ?>"  ><img src="choco brownie.jpg"></A>
                  <h2>Choco Brownie</h2>
              </div>
